            ...
            modelBuilder.Entity("Web_Shoes.Entity.Bills", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            bill_DatetimeOrder = new DateTime(2022, 3, 10, 13, 5, 10, 671, DateTimeKind.Local).AddTicks(610),
                        ...
                        new
                        {
                            ...
                            bill_Cancelled = false,
                            bill_Confirmation = true,
                            bill_DatetimeOrder = new DateTime(2022, 3, 10, 13, 5, 10, 682, DateTimeKind.Local).AddTicks(7170),
                            bill_Delivered = false,
                            bill_Delivering = false,
                            bill_Discount = 0,
                            bill_HideStatus = false,
            ...
            modelBuilder.Entity("Web_Shoes.Entity.Coupons", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            couponId = "3376e115-5452-4324-9255-048d99e70ff7",
                            couponCode = "code10",
                            couponPrice = 10
                        },
                        new
                        {
                            couponId = "d1d9cc7c-9507-41bd-bbdc-e4e23bba30c5",
                            couponCode = "code50",
                            couponPrice = 50
                        });
                });
            ...
            modelBuilder.Entity("Web_Shoes.Entity.Products", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            pd_Img1 = "https://drive.google.com/open?id=1y-bME8oi9DccN-zG_Eo-aChLBs8pwVEI",
            ...
            modelBuilder.Entity("Web_Shoes.Entity.SubReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            subReview_Id = "27d3eb61-3871-43ba-b465-f7d43fdd15c3",
                        ...
                        new
                        {
                            subReview_Id = "453f5945-4bf0-4b25-962c-2207db578c28",
                        ...
                        new
                        {
                            subReview_Id = "e2426809-f085-4013-bb02-df03b6dcb229",
                            subReview_Commnet = "subreview 3",
                            subReview_DateCommnet = new DateTime(2020, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            subReview_HideStatus = false,
                            subReview_UserId = "DE544998-A3CC-4E12-ABB4-0642E57BD222",
            ...
            modelBuilder.Entity("Web_Shoes.Entity.SubReviewInReview", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SRiR_SubReviewId = "27d3eb61-3871-43ba-b465-f7d43fdd15c3"
                        },
                        new
                        {
                            SRiR_ReviewId = "EEBA6608-AB75-4E83-909F-604B1A06F16C",
                            SRiR_SubReviewId = "453f5945-4bf0-4b25-962c-2207db578c28"
                        },
                        new
                        {
                            SRiR_ReviewId = "9EED8607-D2BB-45EE-AEE3-C59D858A7F97",
                            SRiR_SubReviewId = "e2426809-f085-4013-bb02-df03b6dcb229"
                        });
                });
            ...
            modelBuilder.Entity("Web_Shoes.Entity.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "1a196b85-29f7-42bd-a43a-14072f1ed498",
                            Name = "staff",
                            Description = "Staff"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "89dc395d-cea9-4ee3-b809-088941664113",
                            Name = "admin",
                            Description = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Web_Shoes.Entity.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6be47472-cdfb-4037-ab19-593fb4dc1b88",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@GMAIL.COM",
                            NormalizedUserName = "ADMIN@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEJE0usj8Jv+hMj9aO5zSox11LLBmGY8X43HcWixN3hj28WTHJIAmynh7rLqIfBlSJg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "65761e46-bf8e-4078-bd05-b235c56acd19",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "957eba1f-5ffe-4ce3-91d0-d73efba552dd",
                            Email = "staff@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "STAFF@GMAIL.COM",
                            NormalizedUserName = "STAFF@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAENErAMeuQvhLB5kyWozM8oWLYGYtIqC9jcpgCeZDckM95Y47VLoCcckTmxmW+lkS1g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ca85b63f-3ada-4c27-81b3-30f6a19572ce",
                            TwoFactorEnabled = false,
                            UserName = "Staff",
